...
t0=uimenu( F,'Label','Clear','HandleVisibility','off','CallBack','if ~isequal(questdlg(''Sure you want to clear ?'', ''...'', ''Yes'', ''No'', ''No''), ''Yes'');return;end;spm_figure(''Clear'',gcbf)');
t0=uimenu('Parent', F,'Label','PRINT-OK','HandleVisibility','off','CallBack','print -painters -dwin'); %SOSART
