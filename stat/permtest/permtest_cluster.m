function [clusters,pvclusters,pv,S,P,PS]=permtest_cluster(X1,X2,testname,vc,threshold,dims,NP,tails,st,TimeBar,varargin)
%permtest_cluster - Cluster-level permutation test 
%   [clusters,pvclusters,pv,S] = permtest_cluster(X1,X2,testname,vc,threshold,dims,st,NP,TimeBar,tails,testoptions)
...
[pv,S,NP,P,PS] = permtest(X1,X2,testname,dimP,0,NP,TimeBar,tails,varargin{:}); 
if nargout<5
    clear P;
end
PS=squeeze(PS);
