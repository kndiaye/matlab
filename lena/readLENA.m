...
fseek(data_fid,header.data_offset,-1);
...
data = fread(data_fid,str2num(header.description.time_range.time_samples)*...
    length(header.description.sensor_range.sensor_list.sensor),data_type);
data=reshape(data,str2num(header.description.time_range.time_samples), []);
header.Time=[1:str2num(header.description.time_range.time_samples)]...
    ./str2num(header.description.time_range.sample_rate) ...
    - str2num(header.description.time_range.pre_trigger);
