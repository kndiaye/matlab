function gui_setEnabledControls( controls, status, isRecursive )
% GUI_SETENABLEDCONTROLS: Enable/disable control and control's children.
%
% USAGE:  gui_setEnabledControls( controls, status, isRecursive);
%
% INPUT:
