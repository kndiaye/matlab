function [normals, centroid]=normalsOutFaces(vertices, faces)
% [normals, centroid]=normalsfaces(vertices, faces)
% Normals of the (triangular) faces defined by vertices and faces  %
...
inout = sign(sum(centroid .* normals ,2));
