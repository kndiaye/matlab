...
path2bst='/data/brainstorm/confinum/data'
%path2bst='/pclxserver/raid6/data/MONEY/BrainStormData/MONEY_4WAY/data/'
path2anovares='.'
StructName='StatSources';
FilesToFind='MN: MEG(Constr)'; %'MN: MEG(Full,Constr) | zscore'
FileComment='Anova1';   %%% Attention: nom sous lequel le fichier apparaitra dans la base BST
...
OPTIONS.Comment          = 'myanova';   % Default comment for output files (might be overridden)
