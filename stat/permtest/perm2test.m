function [pv,S0,NP,PS,P]=perm2test(X,X2,statistic,dim_p,dim_m,NP,TimeBar,tails,varargin)
% permtest - Generic permutation/randomization test for two-sample statistics
%   [pv,S0,NP,PS,P] = perm2test(X1,X2,statistic,dim_p,dim_m,NP,TimeBar,tails,[testoptions])
%   [pv ... ]       = perm2test(X, N1,statistic,...)
%
...
% Paired case:
[p,K,P,PS]=permtest(X1,X,1,[],999,0);p
