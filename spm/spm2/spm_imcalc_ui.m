...
% 
% KND: the way spm_imcalc_ui calls spm_imcalc does not preserve inputname!
%
Xtra_vars = '';
for i=5:nargin
    eval([inputname(i),' = varargin{i-4};'])
    Xtra_vars = [Xtra_vars ',' inputname(i) ];
end
Vo=eval(['spm_imcalc(Vi,Vo,f,{dmtx,mask,hold}' Xtra_vars ')']);
