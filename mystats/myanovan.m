...
% -*- texinfo -*-
% @deftypefn {Function File} {[{pval}, {f}, {df_b}, {df_e}] =} anovan ({data}, {grps})
% @deftypefnx {Function File} {[{pval}, {f}, {df_b}, {df_e}] =} anovan ({data}, {grps}, 'param1', {value1})
%

% Author: Andy Adler <adler@ncf.ca>
% Based on code by: KH <Kurt.Hornik@ci.tuwien.ac.at>
% $Id: anovan.m,v 1.10 2005/05/30 13:04:41 adb014 Exp $
%
% TESTING RESULTS:
...
for i= order(:)'
    str=  sprintf(' %c x',('A')+find(stats_tbl(i,:)>0)-1 );
