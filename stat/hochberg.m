function [sig,alpha]=hochberg(alpha,n)
% HOCHBERG - Hochberg's adjustment of alpha level for multiple comparisons
%
%   alpha2=hochberg(alpha1, n) computes the new alpha2 to use when running
%   n tests with a familywise error rate of alpha
%   
%   [sig,alphas]=hochberg(alpha,p) assess the significance of the p-values
%   coming from multiple tests according to the Hochberg's procedure
