...
%EEG=pop_epoch(EEG, struct('epoc',1, 'type', '', 'latency', -EEG.xmin*EEG.srate+1))
...
EEG.event.type='TimeZero';
EEG.event.latency = 0;
EEG.epoch.event=[1];
EEG.epoch.eventlatency={EEG.event(1).latency};
EEG.epoch.eventtype={EEG.event(1).type};
