function [filename] = fig2pdf(varargin)
%FIG2PDF - Save a figure into a PDF file 
%   fig2pdf() savethe current figure in the current folder using its name
%   as filename, if name is empty, filename will be like: fig_N.pdf
%   A '_datetime' suffix is added if a file already exists with that name.
%
%    fig2pdf(h) save the figure specified by handle h
%
%    fig2pdf(h,filename) uses the specified filename (may overwrite it)
%
%   Example
%       >> fig2pdf
%
